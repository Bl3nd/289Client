...
public class Class6 {
	...
	public int[] method188(int i, int j) {
		...
		for (int j2 = 0; j2 < 5; j2++) {
			if (anIntArray175[j2] != 0) {
				...
				anIntArray190[j2] = (int) (((double) (aClass1_167.anInt42 - aClass1_167.anInt41) * 32.768000000000001D * Math
		...
		for (int k2 = 0; k2 < i; k2++) {
			...
			if (aClass1_171 != null) {
				...
				j4 = j4
						* ((method189(k6, 0, i2, aClass1_171.anInt43) >> 1) + 32768) >> 15;
				i2 += (k5 * k1 >> 16) + l1;
			}
			for (int l5 = 0; l5 < 5; l5++) {
				if (anIntArray175[l5] != 0) {
					...
					if (l6 < i) {
						anIntArray184[l6] += method189(
								j4 * anIntArray189[l5] >> 15, 0,
								anIntArray187[l5], aClass1_167.anInt43);
						anIntArray187[l5] += (l2 * anIntArray190[l5] >> 16)
								+ anIntArray191[l5];
					}
				}
			}
		...
		if (aClass1_173 != null) {
			...
			for (int i7 = 0; i7 < i; i7++) {
				...
				int k4;
				if (flag1) {
					k4 = aClass1_173.anInt41
							+ ((aClass1_173.anInt42 - aClass1_173.anInt41) * k7 >> 8);
				} else {
					k4 = aClass1_173.anInt41
							+ ((aClass1_173.anInt42 - aClass1_173.anInt41) * i8 >> 8);
				}
				if ((i3 += 256) >= k4) {
					i3 = 0;
					flag1 = !flag1;
		...
		if (aClass2_180.anIntArray52[0] > 0 || aClass2_180.anIntArray52[1] > 0) {
			...
			if (i >= i5 + i6) {
				...
				for (; j7 < l7; j7++) {
					int j8 = (int) ((long) anIntArray184[j7 + i5]
							* (long) Class2.anInt59 >> 16);
					for (int k8 = 0; k8 < i5; k8++) {
						j8 += (int) ((long) anIntArray184[(j7 + i5) - 1 - k8]
								* (long) Class2.anIntArrayArray57[0][k8] >> 16);
					}
					for (int j9 = 0; j9 < j7; j9++) {
						j8 -= (int) ((long) anIntArray184[j7 - 1 - j9]
								* (long) Class2.anIntArrayArray57[1][j9] >> 16);
					}
					anIntArray184[j7] = j8;
				...
				do {
					...
					for (; j7 < l7; j7++) {
						int l8 = (int) ((long) anIntArray184[j7 + i5]
								* (long) Class2.anInt59 >> 16);
						for (int k9 = 0; k9 < i5; k9++) {
							l8 += (int) ((long) anIntArray184[(j7 + i5) - 1
									- k9]
									* (long) Class2.anIntArrayArray57[0][k9] >> 16);
						}
						for (int i10 = 0; i10 < i6; i10++) {
							l8 -= (int) ((long) anIntArray184[j7 - 1 - i10]
									* (long) Class2.anIntArrayArray57[1][i10] >> 16);
						}
						anIntArray184[j7] = l8;
						k3 = aClass1_181.method151(0, i + 1);
					}
				...
				for (; j7 < i; j7++) {
					...
					for (int l9 = (j7 + i5) - i; l9 < i5; l9++) {
						i9 += (int) ((long) anIntArray184[(j7 + i5) - 1 - l9]
								* (long) Class2.anIntArrayArray57[0][l9] >> 16);
					}
					for (int j10 = 0; j10 < i6; j10++) {
						i9 -= (int) ((long) anIntArray184[j7 - 1 - j10]
								* (long) Class2.anIntArrayArray57[1][j10] >> 16);
					}
					anIntArray184[j7] = i9;
	...
	public int method189(int i, int j, int k, int l) {
		try {
			...
			signlink.reporterror("32871, " + i + ", " + j + ", " + k + ", " + l
					+ ", " + runtimeexception.toString());
		}
		throw new RuntimeException();
	}

	public void method190(boolean flag, Stream stream) {
		try {
			if (flag) {
			...
			if (i != 0) {
				...
				aClass1_169.method148(false, stream);
			...
			if (i != 0) {
				...
				aClass1_171.method148(false, stream);
			...
			if (i != 0) {
				...
				aClass1_173.method148(false, stream);
			...
			signlink.reporterror("77565, " + flag + ", " + stream + ", " + runtimeexception.toString());
		}
		throw new RuntimeException();
	}
