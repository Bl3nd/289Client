    ...
    public void method537(boolean flag, Stream class44_sub3_sub2)
    {
        try
        {
            ...
            for(int i = 0; i < 12; i++)
            {
                ...
                {
                    int k1 = Class14.method220(anIntArray1676[i] - 512).anInt368;
                    if(k1 != 0)
                    {
                        anInt1695 = k1;
                    }
        ...
        try
        {
            ...
            if(aClass44_Sub3_Sub4_Sub4_1687 != null)
            {
                ...
                if(client.anInt1240 >= anInt1682 && client.anInt1240 < anInt1683)
                {
                    ...
                    class44_sub3_sub4_sub4_1.method519(anInt1681 - anInt1685, super.anInt1615 - anInt1684, (byte)2, super.anInt1616 - anInt1686);
                }
            }
            class44_sub3_sub4_sub4.aBoolean1568 = true;
            return class44_sub3_sub4_sub4;
    ...
    public Class44_Sub3_Sub4_Sub4 method538(boolean flag)
    {
        try
        {
            if(aClass12_1694 != null)
            {
                ...
                {
                    i = Class26.aClass26Array508[super.anInt1643].anIntArray510[super.anInt1644];
                } else
            ...
            if(super.anInt1643 >= 0 && super.anInt1646 == 0)
            {
                Class26 class26 = Class26.aClass26Array508[super.anInt1643];
            ...
            if(class44_sub3_sub4_sub4_1 == null)
            {
                ...
                for(int k1 = 0; k1 < 12; k1++)
                {
                    ...
                    if(i2 >= 512 && !Class14.method220(i2 - 512).method227(false, anInt1674))
                    {
                        flag1 = true;
                    }
                }
            ...
            if(class44_sub3_sub4_sub4_1 == null)
            {
                ...
                aClass39_1696.method340(l, (byte)76, class44_sub3_sub4_sub4_1);
                aLong1693 = l;
            }
            if(aBoolean1692)
            {
            ...
            if(j != -1 && k != -1)
            {
                class44_sub3_sub4_sub4_2.method515(j, true, k, Class26.aClass26Array508[super.anInt1643].anIntArray514);
            } else
            if(j != -1)
            {
    ...
    public Class44_Sub3_Sub4_Sub4 method539(boolean flag)
    {
        try
        {
            ...
            for(int j = 0; j < 12; j++)
            {
                ...
                if(k >= 512 && !Class14.method220(k - 512).method229(true, anInt1674))
                {
                    flag1 = true;
                }
            }
