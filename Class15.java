...
public class Class15 {
	...
	public Class15(int i, int j, int k, int l, int i1, int j1, int k1, int l1,
			int i2, int j2, int k2, int l2, int i3, int j3, int k3, int l3,
			int i4, int j4, int k4, int l4) {
		aBoolean371 = false;
		aBoolean382 = true;
		try {
			if (i2 != j || i2 != l4 || i2 != k2) {
			...
			signlink.reporterror("80362, " + i + ", " + j + ", " + k + ", " + l
					+ ", " + i1 + ", " + j1 + ", " + k1 + ", " + l1 + ", " + i2
					+ ", " + j2 + ", " + k2 + ", " + l2 + ", " + i3 + ", " + j3
					+ ", " + k3 + ", " + l3 + ", " + i4 + ", " + j4 + ", " + k4
					+ ", " + l4 + ", " + runtimeexception.toString());
		}
