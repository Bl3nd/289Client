...
public class Class3
{
    ...
    public Class3(int ai[][][], int i, byte byte0, byte abyte0[][][], int j)
    {
        anInt60 = 101;
        aBoolean62 = false;
        aBoolean63 = true;
        ...
        {
            signlink.reporterror("68666, " + ai + ", " + i + ", " + byte0 + ", " + abyte0 + ", " + j + ", " + runtimeexception.toString());
    ...
    public void method157(int i, int j, int k, boolean flag, int l)
    {
        ...
        {
            signlink.reporterror("84774, " + i + ", " + j + ", " + k + ", " + flag + ", " + l + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
	...
	try
		...
		while(true)
			...
			if(l2 > 0 && i3 > 0 && l2 < 103 && i3 < 103)
                        {
			    Class8 class8 = Class8.method199(l);
			    if(k2 != 22 || !aBoolean64 || class8.aBoolean226 || class8.aBoolean246)
                            {
        ...
        {
	    signlink.reporterror("52153, " + i + ", " + j + ", " + k + ", " + abyte0 + ", " + runtimeexception.toString());
	    throw new RuntimeException();
	}
    }
    ...
    public static void method160(Class43_Sub1 class43_sub1, Class44_Sub3_Sub2 class44_sub3_sub2, int i)
    {
        try
        {
            ...
            do
            {
                ...
                j += k;
                Class8 class8 = Class8.method199(j);
        ...
        {
            signlink.reporterror("6914, " + class43_sub1 + ", " + class44_sub3_sub2 + ", " + i + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }

    public void method161(int i, int j, byte abyte0[], Class36 class36, byte byte0, Class18 aclass18[])
    {
        try
        {
            Class44_Sub3_Sub2 class44_sub3_sub2 = new Class44_Sub3_Sub2(abyte0, 15787);
        ...
        {
            signlink.reporterror("3868, " + i + ", " + j + ", " + abyte0 + ", " + class36 + ", " + byte0 + ", " + aclass18 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }

    public void method162(int i, int j, Class36 class36, int k, int l, int i1, int j1,
            Class18 class18, int k1)
    {
        try
        {
            if(aBoolean64)
            {
                ...
                if(method164(j1, j, 0, i1) != anInt65)
                {
                    return;
                }
            }
            ...
            if(i == 22)
            {
                if(aBoolean64 && !class8.aBoolean226 && !class8.aBoolean246)
                {
                    return;
                }
                Object obj;
            ...
            if(i == 5)
            {
                ...
                if(l4 > 0)
                {
                    j4 = Class8.method199(l4 >> 14 & 0x7fff).anInt231;
                }
                Object obj13;
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
        ...
        {
            signlink.reporterror("66723, " + i + ", " + j + ", " + class36 + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + class18 + ", " + k1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }

    public void method163(byte byte0, Class18 aclass18[], Class36 class36)
    {
        try
        {
            if(byte0 != 76)
            ...
            for(int k = 0; k < 4; k++)
            {
                ...
                for(int i4 = 1; i4 < anInt67 - 1; i4++)
                {
                    for(int i5 = 1; i5 < anInt66 - 1; i5++)
                    {
                        ...
                        int i17 = (abyte0[i5 - 1][i4] >> 2) + (abyte0[i5 + 1][i4] >> 3) + (abyte0[i5][i4 - 1] >> 2) + (abyte0[i5][i4 + 1] >> 3) + (abyte0[i5][i4] >> 1);
                ...
                for(int k6 = -5; k6 < anInt66 + 5; k6++)
                {
                    for(int l7 = 0; l7 < anInt67; l7++)
                    {
                        ...
                        if(j9 >= 0 && j9 < anInt66)
                        {
                            ...
                            if(k12 > 0)
                            {
                                Class20 class20 = Class20.aClass20Array430[k12 - 1];
                        ...
                        if(l12 >= 0 && l12 < anInt66)
                        {
                            ...
                            if(l13 > 0)
                            {
                                Class20 class20_1 = Class20.aClass20Array430[l13 - 1];
                    ...
                    if(k6 >= 1 && k6 < anInt66 - 1)
                    {
                        ...
                        for(int j17 = -5; j17 < anInt67 + 5; j17++)
                        {
                            ...
                            if(j17 >= 1 && j17 < anInt67 - 1 && (!aBoolean64 || (aByteArrayArrayArray69[k][k6][j17] & 0x10) == 0 && method164(j17, k6, 0, k) == anInt65))
                            {
                                ...
                                if(k18 > 0 || l18 > 0)
                                {
                                    ...
                                    if(k > 0)
                                    {
                                        ...
                                        if(l18 > 0 && !Class20.aClass20Array430[l18 - 1].aBoolean435)
                                        {
                                            flag = false;
                                        }
                                    ...
                                    if(l18 == 0)
                                    {
                                        class36.method283(k, k6, j17, 0, 0, -1, i19, j19, k19, l19, method170(i21, i20), method170(i21, j20), method170(i21, k20), method170(i21, l20), 0, 0, 0, 0, l21, 0);
                                    } else
                                    {
                                        int j22 = aByteArrayArrayArray72[k][k6][j17] + 1;
                                        byte byte5 = aByteArrayArrayArray73[k][k6][j17];
                                        Class20 class20_2 = Class20.aClass20Array430[l18 - 1];
...
label1:
                                ...
                                if(k10 >= 8)
                                {
                                    ...
                                    Class36.method281(j4 * 128, k2, j14, l3 * 128, l3 * 128, 1, k15, k5 * 128 + 128, 1);
...
label3:
                                ...
                                if(j11 >= 8)
                                {
                                    ...
                                    Class36.method281(j3 * 128, k2, k14, l5 * 128 + 128, k4 * 128, 1, l15, j3 * 128, 2);
...
label5:
                                ...
                                if(((i6 - l4) + 1) * ((l8 - j7) + 1) >= 4)
                                {
                                    ...
                                    Class36.method281(j7 * 128, k2, i12, i6 * 128 + 128, l4 * 128, 1, i12, l8 * 128 + 128, 4);
        ...
        {
            signlink.reporterror("24657, " + byte0 + ", " + aclass18 + ", " + class36 + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    {
        int k = (method166(i + 45365, j + 0x16713, 4) - 128) + (method166(i + 10294, j + 37821, 2) - 128 >> 1) + (method166(i, j, 1) - 128 >> 2);
    ...
    public static int method166(int i, int j, int k)
    {
        ...
        int j1 = j / k;
        int k1 = j & k - 1;
        int l1 = method168(l, j1);
        int i2 = method168(l + 1, j1);
        int j2 = method168(l, j1 + 1);
        int k2 = method168(l + 1, j1 + 1);
        int l2 = method167(l1, i2, i1, k);
        int i3 = method167(j2, k2, i1, k);
        return method167(l2, i3, k1, k);
    }
    ...
    {
        int k = method169(i - 1, j - 1) + method169(i + 1, j - 1) + method169(i - 1, j + 1) + method169(i + 1, j + 1);
        int l = method169(i - 1, j) + method169(i + 1, j) + method169(i, j - 1) + method169(i, j + 1);
        int i1 = method169(i, j);
    ...
    public static boolean method173(int i, int j, int k)
    {
        try
        {
            ...
            Class8 class8 = Class8.method199(i);
            if(j == 11)
            {
                j = 10;
            }
    ...
    public static void method174(int i, int j, int k, int l, int ai[][][], int i1, int j1, Class18 class18,
            Class36 class36, int k1, int l1)
    {
        try
        {
            if(l1 != 0)
            ...
            if(l == 5)
            {
                ...
                if(j5 > 0)
                {
                    l4 = Class8.method199(j5 >> 14 & 0x7fff).anInt231;
                }
                Object obj13;
                if(class8.anInt230 == -1 && class8.anIntArray250 == null)
                {
        ...
        {
            signlink.reporterror("39236, " + i + ", " + j + ", " + k + ", " + l + ", " + ai + ", " + i1 + ", " + j1 + ", " + class18 + ", " + class36 + ", " + k1 + ", " + l1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
