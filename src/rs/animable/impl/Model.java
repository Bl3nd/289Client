...
import src.rs.Class21;
import src.rs.Class43;
import src.rs.Class9;
...
public class Model extends Animable {
	...
	public static void method502(byte byte0) {
		try {
			...
			signlink.reporterror("555, " + byte0 + ", "
	...
	public static void method504(byte abyte0[], int i, byte byte0) {
		try {
			...
			class21_1.anInt443 = class44_sub3_sub2.getUnsignedLEShort();
			class21_1.anInt444 = class44_sub3_sub2.getUnsignedLEShort();
			...
			int l1 = class44_sub3_sub2.getUnsignedLEShort();
			int i2 = class44_sub3_sub2.getUnsignedLEShort();
			int j2 = class44_sub3_sub2.getUnsignedLEShort();
			int k2 = 0;
			...
			signlink.reporterror("15458, " + abyte0 + ", " + i + ", " + byte0
					+ ", " + runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public static void method505(byte byte0, int i) {
		try {
			...
			signlink.reporterror("7068, " + byte0 + ", " + i + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public static Model method506(int i, byte byte0) {
		try {
			...
			signlink.reporterror("95716, " + i + ", " + byte0 + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public Model(byte byte0) {
		...
		try {
			...
			signlink.reporterror("97744, " + byte0 + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public Model(byte byte0, int i) {
		...
		try {
			...
			Stream class44_sub3_sub2_1 = new Stream(class21.aByteArray442,
					15787);
			class44_sub3_sub2_1.currentOffset = class21.anInt447;
			Stream class44_sub3_sub2_2 = new Stream(class21.aByteArray442,
					15787);
			class44_sub3_sub2_2.currentOffset = class21.anInt448;
			Stream class44_sub3_sub2_3 = new Stream(class21.aByteArray442,
					15787);
			class44_sub3_sub2_3.currentOffset = class21.anInt449;
			Stream class44_sub3_sub2_4 = new Stream(class21.aByteArray442,
					15787);
			...
			for (int i1 = 0; i1 < anInt1535; i1++) {
				...
				int l1 = 0;
				if ((j1 & 1) != 0) {
					l1 = class44_sub3_sub2_1.getSmartA();
				}
				int j2 = 0;
				if ((j1 & 2) != 0) {
					j2 = class44_sub3_sub2_2.getSmartA();
				}
				int l2 = 0;
				if ((j1 & 4) != 0) {
					l2 = class44_sub3_sub2_3.getSmartA();
				}
			...
			for (int k1 = 0; k1 < anInt1539; k1++) {
				anIntArray1549[k1] = class44_sub3_sub2.getUnsignedLEShort();
			...
			for (int l3 = 0; l3 < anInt1539; l3++) {
				...
				if (i4 == 1) {
					i2 = class44_sub3_sub2.getSmartA() + j3;
					j3 = i2;
					k2 = class44_sub3_sub2.getSmartA() + j3;
					j3 = k2;
					i3 = class44_sub3_sub2.getSmartA() + j3;
					j3 = i3;
			...
			for (int j4 = 0; j4 < anInt1551; j4++) {
				anIntArray1552[j4] = class44_sub3_sub2.getUnsignedLEShort();
				anIntArray1553[j4] = class44_sub3_sub2.getUnsignedLEShort();
				anIntArray1554[j4] = class44_sub3_sub2.getUnsignedLEShort();
			}
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("1962, " + byte0 + ", " + i + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public Model(
			Model aclass44_sub3_sub4_sub4[], int i, int j) {
		anInt1523 = 6;
		aByte1525 = 4;
		aByte1526 = 91;
		anInt1527 = 188;
		...
		try {
			...
			for (int i1 = 0; i1 < i; i1++) {
				...
				if (class44_sub3_sub4_sub4_1 != null) {
					for (int j1 = 0; j1 < class44_sub3_sub4_sub4_1.anInt1539; j1++) {
						...
						if (flag3
								&& class44_sub3_sub4_sub4_1.anIntArray1565 != null) {
			...
			signlink.reporterror("74534, " + aclass44_sub3_sub4_sub4 + ", " + i
	...
	public Model(boolean flag, int i,
			Model aclass44_sub3_sub4_sub4[], int j) {
		anInt1523 = 6;
		aByte1525 = 4;
		aByte1526 = 91;
		anInt1527 = 188;
		...
		try {
			...
			for (int i1 = 0; i1 < j; i1++) {
				...
				if (class44_sub3_sub4_sub4_1 != null) {
					...
					for (int l1 = 0; l1 < class44_sub3_sub4_sub4_1.anInt1539; l1++) {
						anIntArray1540[anInt1539] = class44_sub3_sub4_sub4_1.anIntArray1540[l1]
								+ j1;
						anIntArray1541[anInt1539] = class44_sub3_sub4_sub4_1.anIntArray1541[l1]
								+ j1;
						anIntArray1542[anInt1539] = class44_sub3_sub4_sub4_1.anIntArray1542[l1]
								+ j1;
						...
						if (flag4
								&& class44_sub3_sub4_sub4_1.anIntArray1549 != null) {
							anIntArray1549[anInt1539] = class44_sub3_sub4_sub4_1.anIntArray1549[l1];
						}
						anInt1539++;
					}
					for (int j2 = 0; j2 < class44_sub3_sub4_sub4_1.anInt1551; j2++) {
						anIntArray1552[anInt1551] = class44_sub3_sub4_sub4_1.anIntArray1552[j2]
								+ j1;
						anIntArray1553[anInt1551] = class44_sub3_sub4_sub4_1.anIntArray1553[j2]
								+ j1;
						anIntArray1554[anInt1551] = class44_sub3_sub4_sub4_1.anIntArray1554[j2]
								+ j1;
						anInt1551++;
					}
					l += class44_sub3_sub4_sub4_1.anInt1551;
			...
			signlink.reporterror("44164, " + flag + ", " + i + ", "
					+ aclass44_sub3_sub4_sub4 + ", " + j + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public Model(
			Model class44_sub3_sub4_sub4, boolean flag,
		...
		try {
			...
			signlink.reporterror("54490, " + class44_sub3_sub4_sub4 + ", "
					+ flag + ", " + flag1 + ", " + i + ", " + flag2 + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	...
	public Model(boolean flag, int i,
			Model class44_sub3_sub4_sub4, boolean flag1) {
		anInt1523 = 6;
		aByte1525 = 4;
		aByte1526 = 91;
		anInt1527 = 188;
		...
		try {
			...
			if (flag) {
				...
				super.vertices = new Vertex[anInt1535];
				for (int k1 = 0; k1 < anInt1535; k1++) {
					Vertex class25 = super.vertices[k1] = new Vertex();
					Vertex class25_1 = ((Animable) (class44_sub3_sub4_sub4)).vertices[k1];
			...
			anIntArray1553 = class44_sub3_sub4_sub4.anIntArray1553;
			anIntArray1554 = class44_sub3_sub4_sub4.anIntArray1554;
			super.modelHeight = ((Animable) (class44_sub3_sub4_sub4)).modelHeight;
			...
			signlink.reporterror("37258, " + flag + ", " + i + ", "
					+ class44_sub3_sub4_sub4 + ", " + flag1 + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}

	public void method508(boolean flag,
			Model class44_sub3_sub4_sub4, int i) {
		try {
			anInt1535 = class44_sub3_sub4_sub4.anInt1535;
			anInt1539 = class44_sub3_sub4_sub4.anInt1539;
			anInt1551 = class44_sub3_sub4_sub4.anInt1551;
			...
			if (flag) {
				...
				if (anIntArray1534.length < anInt1539) {
					anIntArray1534 = new int[anInt1539 + 100];
				}
			...
			signlink.reporterror("85838, " + flag + ", "
					+ class44_sub3_sub4_sub4 + ", " + i + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public int method509(Model class44_sub3_sub4_sub4, int i) {
		...
		for (int j1 = 0; j1 < anInt1535; j1++) {
			if (k != anIntArray1536[j1] || l != anIntArray1537[j1]
					|| i1 != anIntArray1538[j1]) {
				continue;
			}
			j = j1;
			break;
	...
	public void method510(int i) {
		try {
			...
			anInt1562 = (int) (Math.sqrt(anInt1559 * anInt1559
					+ super.modelHeight * super.modelHeight) + 0.98999999999999999D);
			anInt1561 = anInt1562
					+ (int) (Math.sqrt(anInt1559 * anInt1559 + anInt1560
							* anInt1560) + 0.98999999999999999D);
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("36717, " + i + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public void method513(byte byte0) {
		try {
			...
			signlink.reporterror("8794, " + byte0 + ", "
					+ runtimeexception.toString());
			throw new RuntimeException();
		}
	}
	...
	public void method514(int i, int j) {
		try {
			...
			Class11 class11 = Class11.method210(i, aByte1525);
			if (class11 == null) {
				return;
			}
			Class9 class9 = class11.aClass9_266;
			anInt1590 = 0;
			anInt1591 = 0;
			anInt1592 = 0;
			for (int k = 0; k < class11.anInt267; k++) {
				int l = class11.anIntArray268[k];
				method516(class9.anIntArray254[l],
						class9.anIntArrayArray255[l], class11.anIntArray269[k],
						class11.anIntArray270[k], class11.anIntArray271[k]);
			}
			j = 30 / j;
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("89296, " + i + ", " + j + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public void method515(int i, boolean flag, int j, int ai[]) {
		try {
			...
			Class11 class11_1 = Class11.method210(j, aByte1525);
			if (!flag) {
				return;
			}
			if (class11_1 == null) {
			...
			for (int i1 = 0; i1 < class11.anInt267; i1++) {
				...
				if (j1 != l || class9.anIntArray254[j1] == 0) {
					method516(class9.anIntArray254[j1],
							class9.anIntArrayArray255[j1],
							class11.anIntArray269[i1],
							class11.anIntArray270[i1],
							class11.anIntArray271[i1]);
				}
			}
			anInt1590 = 0;
			anInt1591 = 0;
			...
			for (int k1 = 0; k1 < class11_1.anInt267; k1++) {
				...
				if (l1 == l || class9.anIntArray254[l1] == 0) {
					method516(class9.anIntArray254[l1],
							class9.anIntArrayArray255[l1],
							class11_1.anIntArray269[k1],
							class11_1.anIntArray270[k1],
							class11_1.anIntArray271[k1]);
				}
			}
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("48519, " + i + ", " + flag + ", " + j + ", "
					+ ai + ", " + runtimeexception.toString());
		}
		throw new RuntimeException();
	}
				...
				if (i3 < anIntArrayArray1566.length) {
					...
					for (int j4 = 0; j4 < ai2.length; j4++) {
						...
						if (i7 != 0) {
							...
							int l8 = anIntArray1537[k5] * j7
									+ anIntArray1536[k5] * i8 >> 16;
							anIntArray1537[k5] = anIntArray1537[k5] * i8
									- anIntArray1536[k5] * j7 >> 16;
							anIntArray1536[k5] = l8;
						}
						if (k6 != 0) {
							int k7 = anIntArray1598[k6];
							int j8 = anIntArray1599[k6];
							int i9 = anIntArray1537[k5] * j8
									- anIntArray1538[k5] * k7 >> 16;
							anIntArray1538[k5] = anIntArray1537[k5] * k7
									+ anIntArray1538[k5] * j8 >> 16;
							anIntArray1537[k5] = i9;
						}
						if (l6 != 0) {
							int l7 = anIntArray1598[l6];
							int k8 = anIntArray1599[l6];
							int j9 = anIntArray1538[k5] * l7
									+ anIntArray1536[k5] * k8 >> 16;
							anIntArray1538[k5] = anIntArray1538[k5] * k8
									- anIntArray1536[k5] * l7 >> 16;
	...
	public void method518(int i, int j) {
		try {
			...
			for (int i1 = 0; i1 < anInt1535; i1++) {
				...
				anIntArray1538[i1] = anIntArray1537[i1] * k
						+ anIntArray1538[i1] * l >> 16;
				anIntArray1537[i1] = j1;
			}
			return;
		} catch (RuntimeException runtimeexception) {
			signlink.reporterror("12713, " + i + ", " + j + ", "
					+ runtimeexception.toString());
		}
		throw new RuntimeException();
	}
	...
	public void method519(int i, int j, byte byte0, int k) {
		try {
			...
			signlink.reporterror("27484, " + i + ", " + j + ", " + byte0 + ", "
	...
	public void method522(int i, int j, int k, byte byte0) {
		try {
			...
			signlink.reporterror("76171, " + i + ", " + j + ", " + k + ", "
	...
	public void method523(int i, int j, int k, int l, int i1, boolean flag) {
		...
		for (int i2 = 0; i2 < anInt1539; i2++) {
			...
			if (anIntArray1546 == null || (anIntArray1546[i2] & 1) == 0) {
				Vertex class25_2 = super.vertices[j2];
				class25_2.anInt500 += l4;
				class25_2.anInt501 += i5;
				class25_2.anInt502 += j5;
				class25_2.anInt503++;
				class25_2 = super.vertices[l2];
				class25_2.anInt500 += l4;
				class25_2.anInt501 += i5;
				class25_2.anInt502 += j5;
				class25_2.anInt503++;
				class25_2 = super.vertices[i3];
				class25_2.anInt500 += l4;
				class25_2.anInt501 += i5;
				class25_2.anInt502 += j5;
				class25_2.anInt503++;
				...
				anIntArray1543[i2] = method525(anIntArray1549[i2], l5,
						anIntArray1546[i2]);
			}
		}
		if (flag) {
			...
			aClass25Array1569 = new Vertex[anInt1535];
			for (int k2 = 0; k2 < anInt1535; k2++) {
				Vertex class25 = super.vertices[k2];
				Vertex class25_1 = aClass25Array1569[k2] = new Vertex();
	...
	public void method524(int i, int j, int k, int l, int i1) {
		for (int j1 = 0; j1 < anInt1539; j1++) {
			...
			if (anIntArray1546 == null) {
				...
				Vertex class25 = super.vertices[k1];
				int k2 = i
						+ (k * class25.anInt500 + l * class25.anInt501 + i1
								* class25.anInt502) / (j * class25.anInt503);
				anIntArray1543[j1] = method525(i3, k2, 0);
				class25 = super.vertices[i2];
				k2 = i
						+ (k * class25.anInt500 + l * class25.anInt501 + i1
								* class25.anInt502) / (j * class25.anInt503);
				anIntArray1544[j1] = method525(i3, k2, 0);
				class25 = super.vertices[j2];
				k2 = i
						+ (k * class25.anInt500 + l * class25.anInt501 + i1
								* class25.anInt502) / (j * class25.anInt503);
				...
				Vertex class25_1 = super.vertices[k1];
				int l2 = i
						+ (k * class25_1.anInt500 + l * class25_1.anInt501 + i1
								* class25_1.anInt502)
						/ (j * class25_1.anInt503);
				anIntArray1543[j1] = method525(j3, l2, k3);
				class25_1 = super.vertices[i2];
				l2 = i
						+ (k * class25_1.anInt500 + l * class25_1.anInt501 + i1
								* class25_1.anInt502)
						/ (j * class25_1.anInt503);
				anIntArray1544[j1] = method525(j3, l2, k3);
				class25_1 = super.vertices[j2];
				l2 = i
						+ (k * class25_1.anInt500 + l * class25_1.anInt501 + i1
								* class25_1.anInt502)
						/ (j * class25_1.anInt503);
	...
	public void method527(boolean flag, boolean flag1, int i) {
		...
		for (int k = 0; k < anInt1539; k++) {
			if (anIntArray1546 == null || anIntArray1546[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					int j5 = (anIntArray1576[l] + anIntArray1576[k1] + anIntArray1576[j2])
							/ 3 + anInt1562;
					anIntArrayArray1581[j5][anIntArray1580[j5]++] = k;
				} else {
					if (flag1
							&& method530(anInt1594, anInt1595,
									anIntArray1575[l], anIntArray1575[k1],
									anIntArray1575[j2], i3, l3, k4)) {
						anIntArray1597[anInt1596++] = i;
						flag1 = false;
					}
					if ((i3 - l3) * (anIntArray1575[j2] - anIntArray1575[k1])
							- (anIntArray1575[l] - anIntArray1575[k1])
							* (k4 - l3) > 0) {
						...
						int k5 = (anIntArray1576[l] + anIntArray1576[k1] + anIntArray1576[j2])
								/ 3 + anInt1562;
		...
		if (anIntArray1582[1] > 0 || anIntArray1582[2] > 0) {
			l2 = (anIntArray1586[1] + anIntArray1586[2])
					/ (anIntArray1582[1] + anIntArray1582[2]);
		}
		int k3 = 0;
		if (anIntArray1582[3] > 0 || anIntArray1582[4] > 0) {
			k3 = (anIntArray1586[3] + anIntArray1586[4])
					/ (anIntArray1582[3] + anIntArray1582[4]);
		}
		int j4 = 0;
		if (anIntArray1582[6] > 0 || anIntArray1582[8] > 0) {
			j4 = (anIntArray1586[6] + anIntArray1586[8])
					/ (anIntArray1582[6] + anIntArray1582[8]);
		}
		int i6 = 0;
	...
	public void method528(int i) {
		...
		if (i1 == 0) {
			Rasterizer.drawShadedTriangle(anIntArray1575[j], anIntArray1575[k],
					anIntArray1575[l], anIntArray1574[j], anIntArray1574[k],
					anIntArray1574[l], anIntArray1543[i], anIntArray1544[i],
					anIntArray1545[i]);
			return;
		}
		if (i1 == 1) {
			Rasterizer.method431(anIntArray1575[j], anIntArray1575[k],
					anIntArray1575[l], anIntArray1574[j], anIntArray1574[k],
					anIntArray1574[l], anIntArray1600[anIntArray1543[i]]);
			return;
		}
		if (i1 == 2) {
			...
			Rasterizer.method433(anIntArray1575[j], anIntArray1575[k],
					anIntArray1575[l], anIntArray1574[j], anIntArray1574[k],
					anIntArray1574[l], anIntArray1543[i], anIntArray1544[i],
					anIntArray1545[i], anIntArray1577[l1], anIntArray1577[j2],
					anIntArray1577[l2], anIntArray1578[l1], anIntArray1578[j2],
					anIntArray1578[l2], anIntArray1579[l1], anIntArray1579[j2],
					anIntArray1579[l2], anIntArray1549[i]);
			return;
		}
		if (i1 == 3) {
			...
			Rasterizer.method433(anIntArray1575[j], anIntArray1575[k],
					anIntArray1575[l], anIntArray1574[j], anIntArray1574[k],
					anIntArray1574[l], anIntArray1543[i], anIntArray1543[i],
					anIntArray1543[i], anIntArray1577[i2], anIntArray1577[k2],
					anIntArray1577[i3], anIntArray1578[i2], anIntArray1578[k2],
					anIntArray1578[i3], anIntArray1579[i2], anIntArray1579[k2],
					anIntArray1579[i3], anIntArray1549[i]);
		}
	}
	...
	public void method529(int i) {
		...
		if (l1 >= 50) {
			...
			if (j2 >= 50) {
				...
				anIntArray1587[l] = j
						+ (k2 + ((anIntArray1577[k1] - k2) * k5 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (k3 + ((anIntArray1578[k1] - k3) * k5 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = k4
						+ ((anIntArray1545[i] - k4) * k5 >> 16);
			}
			if (i2 >= 50) {
				int l5 = (50 - l1) * anIntArray1601[i2 - l1];
				anIntArray1587[l] = j
						+ (k2 + ((anIntArray1577[j1] - k2) * l5 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (k3 + ((anIntArray1578[j1] - k3) * l5 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = k4
						+ ((anIntArray1544[i] - k4) * l5 >> 16);
			}
		}
		if (i2 >= 50) {
			...
			if (l1 >= 50) {
				...
				anIntArray1587[l] = j
						+ (l2 + ((anIntArray1577[i1] - l2) * i6 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (l3 + ((anIntArray1578[i1] - l3) * i6 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = l4
						+ ((anIntArray1543[i] - l4) * i6 >> 16);
			}
			if (j2 >= 50) {
				int j6 = (50 - i2) * anIntArray1601[j2 - i2];
				anIntArray1587[l] = j
						+ (l2 + ((anIntArray1577[k1] - l2) * j6 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (l3 + ((anIntArray1578[k1] - l3) * j6 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = l4
						+ ((anIntArray1545[i] - l4) * j6 >> 16);
			}
		}
		if (j2 >= 50) {
			...
			if (i2 >= 50) {
				...
				anIntArray1587[l] = j
						+ (i3 + ((anIntArray1577[j1] - i3) * k6 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (i4 + ((anIntArray1578[j1] - i4) * k6 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = i5
						+ ((anIntArray1544[i] - i5) * k6 >> 16);
			}
			if (l1 >= 50) {
				int l6 = (50 - j2) * anIntArray1601[l1 - j2];
				anIntArray1587[l] = j
						+ (i3 + ((anIntArray1577[i1] - i3) * l6 >> 16) << 9)
						/ 50;
				anIntArray1588[l] = k
						+ (i4 + ((anIntArray1578[i1] - i4) * l6 >> 16) << 9)
						/ 50;
				anIntArray1589[l++] = i5
						+ ((anIntArray1543[i] - i5) * l6 >> 16);
			}
		}
			...
			if (l == 3) {
				...
				if (l7 == 0) {
					Rasterizer.drawShadedTriangle(i7, j7, k7, j3, j4, j5,
							anIntArray1589[0], anIntArray1589[1],
							anIntArray1589[2]);
				} else if (l7 == 1) {
					Rasterizer.method431(i7, j7, k7, j3, j4, j5,
							anIntArray1600[anIntArray1543[i]]);
				} else if (l7 == 2) {
					int j8 = anIntArray1546[i] >> 2;
					int k9 = anIntArray1552[j8];
					int k10 = anIntArray1553[j8];
					int k11 = anIntArray1554[j8];
					Rasterizer.method433(i7, j7, k7, j3, j4, j5,
							anIntArray1589[0], anIntArray1589[1],
							anIntArray1589[2], anIntArray1577[k9],
							anIntArray1577[k10], anIntArray1577[k11],
							anIntArray1578[k9], anIntArray1578[k10],
							anIntArray1578[k11], anIntArray1579[k9],
							anIntArray1579[k10], anIntArray1579[k11],
							anIntArray1549[i]);
				} else if (l7 == 3) {
					...
					Rasterizer.method433(i7, j7, k7, j3, j4, j5,
							anIntArray1543[i], anIntArray1543[i],
							anIntArray1543[i], anIntArray1577[l9],
							anIntArray1577[l10], anIntArray1577[l11],
							anIntArray1578[l9], anIntArray1578[l10],
							anIntArray1578[l11], anIntArray1579[l9],
							anIntArray1579[l10], anIntArray1579[l11],
							anIntArray1549[i]);
				}
			}
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.centerX
						|| j4 > DrawingArea.centerX || j5 > DrawingArea.centerX
						|| anIntArray1587[3] < 0
						|| anIntArray1587[3] > DrawingArea.centerX) {
					Rasterizer.restrictEdges = true;
				}
				int i8;
				if (anIntArray1546 == null) {
				...
				if (i8 == 0) {
					Rasterizer.drawShadedTriangle(i7, j7, k7, j3, j4, j5,
							anIntArray1589[0], anIntArray1589[1],
							anIntArray1589[2]);
					Rasterizer.drawShadedTriangle(i7, k7, anIntArray1588[3],
							j3, j5, anIntArray1587[3], anIntArray1589[0],
							anIntArray1589[2], anIntArray1589[3]);
					return;
				}
				if (i8 == 1) {
					int l8 = anIntArray1600[anIntArray1543[i]];
					Rasterizer.method431(i7, j7, k7, j3, j4, j5, l8);
					Rasterizer.method431(i7, k7, anIntArray1588[3], j3, j5,
							anIntArray1587[3], l8);
					return;
				}
				if (i8 == 2) {
					...
					Rasterizer.method433(i7, j7, k7, j3, j4, j5,
							anIntArray1589[0], anIntArray1589[1],
							anIntArray1589[2], anIntArray1577[i10],
							anIntArray1577[i11], anIntArray1577[i12],
							anIntArray1578[i10], anIntArray1578[i11],
							anIntArray1578[i12], anIntArray1579[i10],
							anIntArray1579[i11], anIntArray1579[i12],
							anIntArray1549[i]);
					Rasterizer.method433(i7, k7, anIntArray1588[3], j3, j5,
							anIntArray1587[3], anIntArray1589[0],
							anIntArray1589[2], anIntArray1589[3],
							anIntArray1577[i10], anIntArray1577[i11],
							anIntArray1577[i12], anIntArray1578[i10],
							anIntArray1578[i11], anIntArray1578[i12],
							anIntArray1579[i10], anIntArray1579[i11],
							anIntArray1579[i12], anIntArray1549[i]);
					return;
				}
				if (i8 == 3) {
					...
					Rasterizer.method433(i7, j7, k7, j3, j4, j5,
							anIntArray1543[i], anIntArray1543[i],
							anIntArray1543[i], anIntArray1577[j10],
							anIntArray1577[j11], anIntArray1577[j12],
							anIntArray1578[j10], anIntArray1578[j11],
							anIntArray1578[j12], anIntArray1579[j10],
							anIntArray1579[j11], anIntArray1579[j12],
							anIntArray1549[i]);
					Rasterizer.method433(i7, k7, anIntArray1588[3], j3, j5,
							anIntArray1587[3], anIntArray1543[i],
							anIntArray1543[i], anIntArray1543[i],
							anIntArray1577[j10], anIntArray1577[j11],
							anIntArray1577[j12], anIntArray1578[j10],
							anIntArray1578[j11], anIntArray1578[j12],
							anIntArray1579[j10], anIntArray1579[j11],
							anIntArray1579[j12], anIntArray1549[i]);
				}
			}
		}
	}

	public boolean method530(int i, int j, int k, int l, int i1, int j1,
			int k1, int l1) {
		if (j < k && j < l && j < i1) {
			return false;
		}
