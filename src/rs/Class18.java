...
public class Class18
{
    ...
    public Class18(int i, int j, int k)
    {
        anInt405 = -550;
        aBoolean406 = false;
        anInt408 = 8;
    ...
    public void method232(boolean flag, int i, boolean flag1, int j, int k, int l)
    {
        ...
        {
            signlink.reporterror("37924, " + flag + ", " + i + ", " + flag1 + ", " + j + ", " + k + ", " + l + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
    ...
    public void method233(int i, int j, boolean flag, int k, int l, int i1, int j1)
    {
        ...
        {
            signlink.reporterror("81800, " + i + ", " + j + ", " + flag + ", " + k + ", " + l + ", " + i1 + ", " + j1 + ", " + runtimeexception.toString());
            throw new RuntimeException();
        }
    }
            ...
            int l1)
    {
        try
        {
            ...
            if(j1 == l1 - 1 && k >= j && k <= j2 && (anIntArrayArray418[j1 - anInt414][k - anInt415] & 8) == 0 && (k1 & 8) == 0)
            {
                return true;
            }
            if(j1 == i2 + 1 && k >= j && k <= j2 && (anIntArrayArray418[j1 - anInt414][k - anInt415] & 0x80) == 0 && (k1 & 2) == 0)
            {
                return true;
            }
            if(k == j - 1 && j1 >= l1 && j1 <= i2 && (anIntArrayArray418[j1 - anInt414][k - anInt415] & 2) == 0 && (k1 & 4) == 0)
            {
                return true;
            }
            return k == j2 + 1 && j1 >= l1 && j1 <= i2 && (anIntArrayArray418[j1 - anInt414][k - anInt415] & 0x20) == 0 && (k1 & 1) == 0;
        }
        catch(RuntimeException runtimeexception)
        {
