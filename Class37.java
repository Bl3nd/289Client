...
public class Class37
{
    ...
    public static Class40 aClass40_669 = new Class40();
    ...
    public static int method329(byte abyte0[], int i, byte abyte1[], int j, int k)
    {
        synchronized(aClass40_669)
        {
            ...
            method331(aClass40_669);
            i -= aClass40_669.anInt713;
            int l = i;
            return l;
        }
    }
...
label0:
    ...
    public static void method331(Class40 class40)
    {
        ...
        int ai2[] = null;
        class40.anInt721 = 1;
        if(Class40.anIntArray730 == null)
        {
            Class40.anIntArray730 = new int[class40.anInt721 * 0x186a0];
        }
        boolean flag19 = true;
        while(flag19)
        {
            ...
            for(int l3 = 0; l3 < j4; l3++)
            {
                ...
                method336(class40.anIntArrayArray740[l3], class40.anIntArrayArray741[l3], class40.anIntArrayArray742[l3], class40.aByteArrayArray739[l3], byte8, i, i4);
                class40.anIntArray743[l3] = byte8;
            }
            int l4 = class40.anInt731 + 1;
            int l5 = 0x186a0 * class40.anInt721;
            int i5 = -1;
            int j5 = 0;
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
            {
                if(k5 == 0 || k5 == 1)
                {
                    ...
                    for(; j6 > 0; j6--)
                    {
                        Class40.anIntArray730[i6] = byte5 & 0xff;
                        i6++;
                    }
                } else
                {
                    ...
                    Class40.anIntArray730[i6] = class40.aByteArray734[byte6 & 0xff] & 0xff;
                    i6++;
                    if(j5 == 0)
                    {
                        i5++;
            ...
            {
                byte byte7 = (byte)(Class40.anIntArray730[l2] & 0xff);
                Class40.anIntArray730[class40.anIntArray728[byte7 & 0xff]] |= l2 << 8;
                class40.anIntArray728[byte7 & 0xff]++;
            }
            class40.anInt724 = Class40.anIntArray730[class40.anInt723] >> 8;
            class40.anInt727 = 0;
            class40.anInt724 = Class40.anIntArray730[class40.anInt724];
