...
public class Class44_Sub3_Sub4_Sub4 extends Class44_Sub3_Sub4
{
    ...
    public static Class44_Sub3_Sub4_Sub4 aClass44_Sub3_Sub4_Sub4_1530 = new Class44_Sub3_Sub4_Sub4((byte)91);
    ...
    public static Class44_Sub3_Sub4_Sub4 method506(int i, byte byte0)
    {
        try
        {
            if(byte0 == 4)
            ...
            {
                return new Class44_Sub3_Sub4_Sub4((byte)5, i);
            }
        }
        catch(RuntimeException runtimeexception)
        {
    ...
    public Class44_Sub3_Sub4_Sub4(byte byte0)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
    ...
    public Class44_Sub3_Sub4_Sub4(byte byte0, int i)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
    ...
    public Class44_Sub3_Sub4_Sub4(Class44_Sub3_Sub4_Sub4 aclass44_sub3_sub4_sub4[], int i, int j)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
        ...
        try
        {
            ...
            for(int k = 0; k < i; k++)
            {
                Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4 = aclass44_sub3_sub4_sub4[k];
            ...
            {
                Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4_1 = aclass44_sub3_sub4_sub4[i1];
                if(class44_sub3_sub4_sub4_1 != null)
                {
                    for(int j1 = 0; j1 < class44_sub3_sub4_sub4_1.anInt1539; j1++)
                    {
                        ...
                        anIntArray1540[anInt1539] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1540[j1]);
                        anIntArray1541[anInt1539] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1541[j1]);
                        anIntArray1542[anInt1539] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1542[j1]);
                        anInt1539++;
                    }
                    for(int l1 = 0; l1 < class44_sub3_sub4_sub4_1.anInt1551; l1++)
                    {
                        anIntArray1552[anInt1551] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1552[l1]);
                        anIntArray1553[anInt1551] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1553[l1]);
                        anIntArray1554[anInt1551] = method509(class44_sub3_sub4_sub4_1, class44_sub3_sub4_sub4_1.anIntArray1554[l1]);
                        anInt1551++;
                    }
        ...
        {
            signlink.reporterror("74534, " + aclass44_sub3_sub4_sub4 + ", " + i + ", " + j + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }

    public Class44_Sub3_Sub4_Sub4(boolean flag, int i, Class44_Sub3_Sub4_Sub4 aclass44_sub3_sub4_sub4[], int j)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
    ...
    public Class44_Sub3_Sub4_Sub4(Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4, boolean flag, boolean flag1, int i, boolean flag2)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
    ...
    public Class44_Sub3_Sub4_Sub4(boolean flag, int i, Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4, boolean flag1)
    {
        anInt1523 = 6;
        aByte1525 = 4;
        aByte1526 = 91;
    ...
    public void method508(boolean flag, Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4, int i)
    {
        try
        {
            anInt1535 = class44_sub3_sub4_sub4.anInt1535;
    ...
    public int method509(Class44_Sub3_Sub4_Sub4 class44_sub3_sub4_sub4, int i)
    {
        int j = -1;
    ...
    public void method519(int i, int j, byte byte0, int k)
    {
        ...
        {
            signlink.reporterror("27484, " + i + ", " + j + ", " + byte0 + ", " + k + ", " + runtimeexception.toString());
        }
        throw new RuntimeException();
    }
    ...
    public void method523(int i, int j, int k, int l, int i1, boolean flag)
    {
        ...
        for(int i2 = 0; i2 < anInt1539; i2++)
        {
            ...
            } else
            {
                ...
                anIntArray1543[i2] = method525(anIntArray1549[i2], l5, anIntArray1546[i2]);
            }
        }
        if(flag)
        {
